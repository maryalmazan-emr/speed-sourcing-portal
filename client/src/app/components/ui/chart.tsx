...
/** Re-export the native Recharts Tooltip/Legend components (no self-reference). */
export const ChartTooltip = RechartsPrimitive.Tooltip;
export const ChartLegend = RechartsPrimitive.Legend;

/** Minimal payload types to keep TS strict-mode happy without relying on Recharts internal typings. */
  ...
  return (
    ...
    >
      {payload.map((entry, idx) => {
        ...
        return (
          <div
            key={`legend-${entry.dataKey ?? entry.name ?? idx}`}
            className={cn(
          ...
          >
            ...
            <span className="text-sm">
              {itemConfig?.label || entry.name || String(entry.value ?? "")}
            </span>
          </div>
        );
      })}
